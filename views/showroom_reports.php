...
<body>
    <div class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a class="nav-item active" href="showroom_reports.php">Showroom Reports</a>
    ...
    <div class="main-content">
        ...
        <h1 class="page-title">Showroom Reports</h1>
        ...
        <div class="table-container" style="margin-top:24px;">
            ...
            <p class="section-subtitle">Full inventory snapshot for reporting.</p>
            <table>
                <tr><th>BRAND</th><th>MODEL</th><th>YEAR</th><th>PRICE</th><th>STATUS</th></tr>
                <?php
                ...
                if (!empty($vehicles)) {
                    foreach ($vehicles as $v) {
                        ...
                        echo "<td>$" . htmlspecialchars(number_format($v['price'])) . "</td>";
